...
mvn install:install-file -Dfile=db2jcc_license_cu-9.5.jar -DgroupId=com.ibm.db2.jcc_license_cu -DartifactId=db2jcc_license_cu -Dversion=9.5 -Dpackaging=jar -DgeneratePom=true
