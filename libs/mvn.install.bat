...
rem mvn install:install-file -Dfile=db2jcc4-9.7.2.jar -DgroupId=com.ibm.db2.jcc -DartifactId=db2jcc4 -Dversion=9.7.2 -Dpackaging=jar -DgeneratePom=true
rem mvn install:install-file -Dfile=db2jcc_license_cu-9.7.2.jar -DgroupId=com.ibm.db2.jcc_license_cu -DartifactId=db2jcc_license_cu -Dversion=9.7.2 -Dpackaging=jar -DgeneratePom=true
...
rem mvn install:install-file -Dfile=canyon-0.9.8.jar -DgroupId=canyon -DartifactId=canyon -Dversion=0.9.8 -Dpackaging=jar -DgeneratePom=true