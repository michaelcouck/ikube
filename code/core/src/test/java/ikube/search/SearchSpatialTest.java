...
public class SearchSpatialTest extends AbstractTest {
    ...
    @Test
    @Ignore
    public void geospatialSearchPerformance() throws IOException {
        File indexDirectory = new File("/home/indexes/geoname-csv/1471001064206/127.0.0.1-8000/");
        ...
        searchSpatial.setFragment(Boolean.FALSE);
        ...
        PERFORMANCE.execute(new PERFORMANCE.IPerform() {
        ...
        }, "Spatial performance test : ", 1000, true);
    }
