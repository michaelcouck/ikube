 ...
 * @since 20-07-2014
 */
public class DestroyerTest extends AbstractTest {
    ...
    public void before() throws Exception {
        ...
        }).when(destroyer).getAnalyticsService();
    ...
    public void call() throws Exception {
        boolean destroyed = destroyer.call();
        assertTrue(destroyed);
        verify(ianalyzer, atLeastOnce()).destroy(any(Context.class));
    }
