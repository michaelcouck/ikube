...
public class GeospatialEnrichmentStrategyTest extends AbstractTest {
    ...
    public void getCoordinate() throws Exception {
        ...
        Coordinate coordinate = geospatialEnrichmentStrategy.getCoordinate(indexableTable.getChildren());
    ...
    public void buildAddress() throws Exception {
        ...
        indexableTable.setChildren(new ArrayList<Indexable>(Collections.singletonList(indexableColumn)));
        String actual = geospatialEnrichmentStrategy.buildAddress(indexableTable.getChildren());

        logger.info("Address : " + actual);
        assertEquals("The combined address from the columns : ", expected, actual);
    }
