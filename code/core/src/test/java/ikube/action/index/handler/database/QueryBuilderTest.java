...
public class QueryBuilderTest extends AbstractTest {
    ...
    public void buildCountQuery() {
        try {
            ...
            String countQuery = QueryBuilder.buildCountQuery(indexableTable, 0l, 1l);
            logger.info("Count query : " + countQuery);
            assertEquals("select count(*) from indexableTable where column-name > 0 and column-name < 1", countQuery);
        } finally {
