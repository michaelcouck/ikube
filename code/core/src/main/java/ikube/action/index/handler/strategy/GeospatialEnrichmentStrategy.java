...
public final class GeospatialEnrichmentStrategy extends AGeospatialEnrichmentStrategy {
    ...
    public boolean aroundProcess(final IndexContext indexContext, final Indexable indexable, final Document document, final Object resource)
        ...
        // First try the resource to see if it is the list of columns
        if (resource != null && List.class.isAssignableFrom(resource.getClass())) {
            //noinspection unchecked
            coordinate = getCoordinate((List<Indexable>) resource);
        } else {
            coordinate = getCoordinate(indexable.getChildren());
        }
        if (coordinate != null) {
     ...
     *
     * @param indexables the indexables to try to find ge-spatial data in
     ...
     */
    final Coordinate getCoordinate(final List<Indexable> indexables) {
        Double latitude = null;
        Double longitude = null;
        for (final Indexable child : indexables) {
        ...
        if (latitude != null && longitude != null) {
            ...
            String address = buildAddress(indexables);
    ...
    final String buildAddress(final List<Indexable> indexables) {
