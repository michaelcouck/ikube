...
public interface IResourceHandler<T> {
    ...
    /**
     * This method will process the resource, extracting the data from whatever type of document or resource it is,
     * and adding all the data to the fields in the document. This could take a column in a tables for example.
     *
