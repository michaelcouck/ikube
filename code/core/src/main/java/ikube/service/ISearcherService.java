...
public interface ISearcherService {
	 ...
	 * 
	 * @param indexName
	 *            the name of the index to search, must be a geo-spatial index
	 * @param searchStrings
	 *            the search strings to use to search the fields
	 * @param fragment
	 *            whether to produce a fragment of highlights from the content
	 * @param firstResult
	 *            the first result in the top results, for paging
	 * @param maxResults
	 *            the maximum results to return
	 * @param distance
	 *            the maximum distance to search through the results
	 * @param latitude
	 *            the latitude of the co-ordinate to use as the point of origin. This is the point that the results will be sorted from
	 * @param longitude
	 *            the longitude of the co-ordinate to use as the point of origin
	 * @return the results from the search, an {@link ArrayList} of {@link HashMap}s, that have the id, score, fragment (optional), all the
	 *         fields and their contents if they were stored in the index, and finally the statistics map, which contains the corrected
	 *         search strings, the duration of the search and the total number of results for the search
	 */
	 ...
	 *            the name of the index to search
	 * @param searchStrings
	 *            the strings that are used to generate the Lucene query
	 * @param searchFields
	 *            the fields in the index to search
	 * @param fragment
	 *            whether to generate a fragment of highlight in the results
	 * @param firstResult
	 *            the first result in the set, used for paging the results
	 * @param maxResults
