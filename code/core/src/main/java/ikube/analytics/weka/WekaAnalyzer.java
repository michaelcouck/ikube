...
public abstract class WekaAnalyzer implements IAnalyzer<Analysis<Object, Object>, Analysis<Object, Object>, Analysis<Object, Object>> {
    ...
    /**
     * This is a filter that will convert the input data into a format that the Weka algorithm can
     * process. For example from strings to double array. Typically the underlying algorithms do not fair
     * too well with strings
     */
    transient Filter filter;
    /**
     * This is the set of instance data, the model that is generated by the algorithm, and the model
     * that is used for analyzing each further instance.
     */
    transient Instances instances;
    /**
     * The buiding and training needs to be atomic, this controls that between methods.
     */
