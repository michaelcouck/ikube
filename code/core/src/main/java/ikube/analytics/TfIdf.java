...
/**
 * Wrapper object that consists all necessary information for calculating tfidf value for each term. Use method getValue() to get the actual tfidf value.
 * 
 * @author Aniket
 * 
 */
public class TfIdf implements Comparable<TfIdf> {
	...
	/**
	 * Calculates the tf-idf value of the current term. For description of tf-idf refer to <a href="http://en.wikipedia.org/wiki/Tf–idf">^
	 * wikipedia.org/Tf–idf</a> <br />
	 * Because there can be many cases where the current term is not present in any other document in the repository, Float.MIN_VALUE is added to the
