...
public class AsposePowerPointParser implements IParser {
	...
	private void getText(final InputStream inputStream, final OutputStream outputStream) throws IOException {
	...
	private void getText(TextFrameEx TxtFrame, OutputStream outputStream) throws IOException {
