...
public final class Optimizer {
    ...
    public static void main(String[] args) {
        try {
            ...
            LOGGER.error(
                    "The directories do not have to be absolute, the logic will search for " +
                            "the segments files starting at the directory specified");
            LOGGER.error(
                    "Usage : java -jar ikube-tools.jar ikube.toolkit.Optimizer [lucene-index-to-optimize lucene-index-to-optimize lucene-index-to-optimize...]");
            LOGGER.error(null, e);
        }
    }
