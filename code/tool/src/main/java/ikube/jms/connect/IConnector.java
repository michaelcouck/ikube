...
public interface IConnector {
    ...
    /**
     * This method connects to the specified(sub class implementation) JMS provider be that WebSphere JMS or
     * ActiveMQ. The JMS template is populated with the {@link javax.jms.ConnectionFactory}
     *
     * @param userid            the user name to use to connect to the destinations
     * @param password          the password for the same above
     * @param url               the url for the provider, typically to open the initial context on the remote machine
