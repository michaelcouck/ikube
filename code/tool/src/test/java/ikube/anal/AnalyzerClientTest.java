...
public class AnalyzerClientTest extends AbstractTest {
    ...
    public void invertTraining() throws Exception {
        ...
        for (final Object[] row : invertedData) {
            double[] doubleRow = MatrixUtilities.objectArrayToDoubleArray(row, invertedData[0].length);
        ...
        for (final Object[] invertedRow : invertedData) {
            double[] doubleRow = MatrixUtilities.objectArrayToDoubleArray(invertedRow, invertedData[0].length);
