 ...
 */
var module = angular.module('site', [ 'ui.bootstrap' ]);
...
var searcherController = module.controller('SearcherController', function($http, $scope, $location, $rootScope) {
	...
	$scope.doSearch = function(firstResult) {
		...
		$scope.url = 'http://www.ikube.be:8080/ikube/service/search/json/single';
...
searcherController.$inject = ['$scope', '$filter', '$location'];
