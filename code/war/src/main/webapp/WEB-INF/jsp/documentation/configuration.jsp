<table class="table-content" width="100%">
	...
	<tr>
		<td class="td-content" colspan="2">TODO - web site configuration</td>
	</tr>
	
	<tr>
		<td class="td-content" colspan="2">TODO - email configuration</td>
	</tr>
	
	<tr>
		<td class="td-content" colspan="2">TODO - file share configuration</td>
	</tr>
