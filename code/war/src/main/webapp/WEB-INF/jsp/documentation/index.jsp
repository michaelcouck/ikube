<table class="table-content" width="100%">
	<tr>
		<td class="top-content">
			<span class="top-content-header">Documentation</span>
	...
	<tr>
		<td class="td-content">
			<strong>ikube</strong>
				Having arrived here you have probably read the <a href="http://code.google.com/p/ikube/" target="_top">Ikube Wiki</a> introduction 
				on Google Code, so no real introduction is necessary here, so to brass tacks as it were.
				<br><br>
	...
	<tr>
		<td class="td-content">
				...
				increase by a factor every year performance is paramount.
			</td>
	</tr>
	<tr>
		<td class="td-content">
				Please try the quick start page and move on to more complex index configurations when that is all up and running. Feel 
				free to mail me if you have any difficulty with the configuration, or if my writing style is not clear or with any suggestions 
				at michael dot couck at gmail dot com.
				<br><br>
