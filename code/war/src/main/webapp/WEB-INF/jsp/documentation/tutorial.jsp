	...
	<tr>
		<td class="td-content" colspan="2">
			<strong>tutorial</strong>&nbsp;
			 This is the step by step tutorial for setting up Ikube with the default configuration(in the war).<br><br>
			 ...
			 6) Start the Tomcat<br>
			 7) Go to the <a href="http://localhost:8080/ikube/admin/servers.html">monitoring</a> page<br>
