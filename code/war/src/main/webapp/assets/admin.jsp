...
<link
	href="/ikube/assets/stylesheets/application.css"
	media="screen" rel="stylesheet" type="text/css" />
	
	<script
		src="http://beer2code.com/themes/plastique/javascripts/application.js"
		type="text/javascript"></script>
	<script src="http://beer2code.com/themes/plastique/javascripts/docs.js"
		type="text/javascript"></script>
	<script
		src="http://beer2code.com/themes/plastique/javascripts/docs_charts.js"
		type="text/javascript"></script>
	<!-- <script
		src="http://beer2code.com/themes/plastique/javascripts/documentation.js"
		type="text/javascript"></script> -->
	<!-- <script
		src="http://beer2code.com/themes/plastique/javascripts/prettify.js"
		type="text/javascript"></script> -->
	<!-- <link
		href="http://beer2code.com/themes/plastique/stylesheets/prettify.css"
		media="screen" rel="stylesheet" type="text/css" /> -->
...
<body>
	...
	<div id="modal-gallery" class="black-box modal modal-gallery hide fade">
		...
		<div class="modal-footer">
			...
			<div class="pull-right">
				<a class="button blue modal-next">Next <i
					class="icon-arrow-right icon-white"></i></a> <a
					class="button gray modal-prev"><i
					class="icon-arrow-left icon-white"></i> Previous</a> <a
					class="button green modal-play modal-slideshow"
					data-slideshow="5000"><i class="icon-play icon-white"></i>
					Slideshow</a> <a class="button black" target="_blank"><i
	...
	<nav id="primary" class="main-nav">
		<ul>
			...
			<li class=""><a href="../form_elements/standard.html"> <i
					class="icon-list-alt"></i> Forms
			</a></li>

			<li class=""><a href="../user_interface/buttons_dropdowns.html">
					<i class="icon-beaker"></i> UI Lab
			</a></li>

			<li class=""><a href="../widgets/widgets.html"> <i
					class="icon-plus-sign"></i> Widgets
			</a></li>

			<li class=""><a href="../charts/charts.html"> <i
					class="icon-bar-chart"></i> Charts
			</a></li>

			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown"><i class="icon-share-alt"></i>More <span
					class="caret"></span></a>

				<ul class="dropdown-menu">
					<li><a href="../error_404.html"> <i
							class="icon-warning-sign"></i> Error 404
					</a></li>


					<li class="divider"></li>
					<li><a href="../login/login.html"> <i class="icon-off"></i>
							Log out (login page)
					</a></li>
				</ul></li>
	...
	<nav id="secondary" class="main-nav">
		...
		<div class="profile-menu">
			...
			<div class="pull-left">
				<div class="avatar">
					<img src="http://beer2code.com/themes/plastique/images/avatar.png" />
				</div>
			</div>
			...
			<div class="row-fluid">
				<div class="span6">
					...
					<div class="row-fluid">
						<div class="span12">
							<div class="box">
								<div class="tab-header">System status</div>
								<div class="padded">
								...
								<ul class="recent-comments">
									...
									<li class="separator">
										<div class="avatar pull-left">
											<img
												src="http://beer2code.com/themes/plastique/images/avatar.png" />
										</div>
					...
					<div class="footer">
						...
						<div>
							Carefully crafted by <a
								href="https://wrapbootstrap.com/user/andrei4002">andrei4002</a>
						</div>
					</div>
				</div>
			</div>
  ...
  <div class="container">
	...
	<script type="text/javascript">
		$(function() {
			Notifications.push({
				imagePath : "http://beer2code.com/themes/plastique/images/cloud.png",
