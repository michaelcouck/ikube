...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=visualization&key=AIzaSyDo6nezSUreFVSjX_RIDEwVzPvLzKNKkyk"></script>
            ...
            <div class="row-fluid">
                <div style="margin-bottom: 20px;">
                    <div class="big-button-bar">
                        <a class="button large" href="<c:url value="/assets/apps/happy.jsp" />"><i class="icon-search"></i><span>Happy Planet</span></a>
                        <a class="button large" href="<c:url value="/assets/apps/twitter.jsp" />"><i class="icon-zoom-in"></i><span>Sentiment Timeline</span></a>
