...
public abstract class Searcher extends Resource {
	 ...
	 * @return a serialized string of the results from the search
	 */
	abstract Response searchMulti(final String indexName, final String searchStrings, final String searchFields, final boolean fragment, final int firstResult,
	 ...
	 * @return a serialized string of the results from the search
	 */
	abstract Response searchMultiSorted(final String indexName, final String searchStrings, final String searchFields, final String sortFields,
	 ...
	 * @return a serialized string of the results from the search
	 */
	abstract Response searchMultiAll(final String indexName, final String searchStrings, final boolean fragment, final int firstResult, final int maxResults);
	 ...
	 * @return a serialized string of the results from the search
	 */
	abstract Response searchMultiSpacial(final String indexName, final String searchStrings, final String searchFields, final boolean fragment,
	 ...
	 * @return the results around the point specified, going the maximum distance specified, sorted according to the distance from the point specified
	 */
	abstract Response searchMultiSpacialAll(final String indexName, final String searchStrings, final boolean fragment, final int firstResult,
			final int maxResults, final int distance, final String latitude, final String longitude);

	/**
	 * TODO Comment me.
	 */
	abstract Response searchMultiAdvanced(final String indexName, final String searchStrings, final String searchField, final boolean fragment,
			final int firstResult, final int maxResults);

	/**
	 * TODO Comment me.
	 */
	abstract Response searchNumericAll(final String indexName, final String searchStrings, final boolean fragment, final int firstResult, final int maxResults);

	/**
	 * TODO Comment me.
	 */
	abstract Response searchNumericRange(final String indexName, final String searchStrings, final boolean fragment, final int firstResult, final int maxResults);
