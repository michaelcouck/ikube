...
/**
 * This is the base for the controllers. The method getViewUrl will strip the file name and the context from the request url so that the mapping in the Spring
...
public abstract class BaseController /* extends AbstractController */{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
		return null; // handleRequest(request, response);
	}

	/**
	 * This method returns the uri for the target page. The Url for the application will be something like /ikube/admin/search.html, but Spring wants to map the
	 * /admin/search to /admin/search.jsp, so it will prepend the .jsp to the uri before forwarding. This method remove the context(ikube) and the .html from
	 * the uri and leave /admin/search for Spring to map forward.
	 * 
