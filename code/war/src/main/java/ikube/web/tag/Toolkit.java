...
public class Toolkit {
     ...
     */
    public static Collection<?> remove(final Collection<?> one, final Collection<?> two) {
    ...
    public static Collection<?> add(final Collection<Object> one, final Collection<Object> two) {
        if (one == null || two == null) {
            if (one == null) {
                return two;
            }
    ...
    public static Collection<Object> clone(final Collection<Object> collection) {
        if (collection == null) {
            return null;
        }
    ...
    public static String concatenate(final String one, final String two) {
        return one + two;
    }
    ...
    public static Object fieldValue(final String fieldName, final Object object) {
        ...
        return ObjectToolkit.getFieldValue(object, fieldName);
    }
