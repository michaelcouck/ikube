...
public class ApplicationContextManagerWebMock {

	static {
		Logging.configure();
	}

	private static final Logger			LOGGER				= Logger.getLogger(ApplicationContextManagerWebMock.class);
	...
	public static synchronized <T> T getBean(final Class<T> klass) {
		Field[] fields = ApplicationContextManagerWebMock.class.getDeclaredFields();
