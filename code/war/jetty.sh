...
#export MAVEN_OPTS="-XX:PermSize=256m -XX:MaxPermSize=512m -Xms1024m -Xmx3076m -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,address=4000,server=y,suspend=n"
