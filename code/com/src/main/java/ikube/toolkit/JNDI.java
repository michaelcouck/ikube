...
public class JNDI {
     ...
     * @param object   The object to be bound into JNDI
     * @throws javax.naming.NamingException If the operation is not possible to be executed.
     */
    public static void bind(final String jndiName, final Object object) throws NamingException {
        ...
        try {
            ...
            LOGGER.info("Object not bound : " + jndiName, e);
        } finally {
