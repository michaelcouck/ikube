...
public class SearcherWebServiceTest extends BaseTest {
	...
	public void searchSingle() {
		String result = this.searcherWebService.searchSingle(indexContext.getName(), "search string", IConstants.CONTENTS, Boolean.TRUE, 0,
				10);
	...
	public void searchMulti() {
		String result = this.searcherWebService.searchMulti(indexContext.getName(), new String[] { "search", "strings" }, new String[] {
